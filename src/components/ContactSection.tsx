...
const WEB3FORMS_ACCESS_KEY = '7d78b493-1187-475a-89ba-e2b1a30240c2'
...
export default function ContactSection() {
  ...
  const socialLinks = [
    { name: 'GitHub', icon: Github, url: 'https://github.com/AnuragSinghParmar' },
    { name: 'LinkedIn', icon: Linkedin, url: 'https://linkedin.com/in/anurag-parmar111/' },
    { name: 'Email', icon: Mail, url: 'mailto:anuragparmar8205@gmail.com' }
  ]
        ...
        {status && (
          <div style={{
            ...
            border: `1px solid ${status.type === 'success'
              ? 'rgba(0, 229, 255, 0.3)'
              : 'rgba(255, 80, 80, 0.3)'}`,
            color: status.type === 'success' ? '#00E5FF' : '#FF5050'
          }}>
            {status.type === 'success'
